...
Adafruit_I2CDevice::Adafruit_I2CDevice(uint8_t addr, i2c_inst_t *i2c){
  _addr = addr;
  _i2c = i2c;
  _begun = false;
...
bool Adafruit_I2CDevice::detected(void) {
  ...
  uint8_t rxdata;
  int ret = ret = i2c_read_blocking(_i2c, _addr, &rxdata, 1, false);
  return ret>0;
...
bool Adafruit_I2CDevice::setSpeed(uint32_t desiredclk) {
	uint32_t ret =  i2c_set_baudrate (
			 	 	 	 	 	 	 _i2c,
									 desiredclk);
	return ret == desiredclk;
