...
#define DISTANCE_TOPIC "/Astro/distance"
#define MAX_HCSR04_SENSORS 	3
...
public:
	...
	void addSensor(uint trigger, uint echo, const char * name);
...
private:
	...
	HCSR04Range* pSensors[MAX_HCSR04_SENSORS];
	uint xSensorCount = 0;
